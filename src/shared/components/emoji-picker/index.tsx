  ...
  return (
    <div ref={ref} className="relative inline-block">
      ...
      >
        ...
        >
          <svg className="w-2.5 h-2.5 text-gray-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="grid grid-cols-10 gap-1 p-2 max-h-32 overflow-y-auto">
            {emojis.map(emoji => (
              <button
                key={emoji}
                type="button"
                onClick={() => { field.onChange(emoji); setOpen(false) }}
